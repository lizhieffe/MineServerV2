...
alter table user add constraint fk_user_credential_3 foreign key (user_credential_id) references user_credential (id) on delete restrict on update restrict;
create index ix_user_credential_3 on user (user_credential_id);
